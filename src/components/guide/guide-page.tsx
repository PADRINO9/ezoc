...
const dailyFlow = [
  ...
  },
  {
    ...
    text: "קודם חסרים פרטים, אמון נמוך, מחיר, או ״כמו פעם שעברה״.",
    icon: AlertTriangle,
  },
  {
    title: "פותחים הזמנה",
  ...
  },
  {
    ...
    notes: [
      ...
      },
      {
        n: "2",
        title: "בדיקת AI",
        text: "אמון נמוך או פרטים חסרים אומרים שצריך לבדוק לפני אישור.",
      },
      {
        n: "3",
        title: "עריכה",
  ...
  },
  {
    ...
    notes: [
      ...
      },
      {
        ...
        text: "מראה מה מוכן לחיבור עתידי: Supabase, WhatsApp ו-OpenAI.",
      },
    ],
...
const buttonGuide = [
  ...
  },
  {
    ...
    meaning: "שומר הודעה, מפעיל parser, יוצר הזמנה ותשובת מערכת.",
    icon: Send,
  },
  {
    button: "פתח / בדיקה",
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {[
              ...
              "אם אמון AI נמוך מ-85%: בודקים ידנית.",
